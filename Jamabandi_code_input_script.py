...
class JamabandiCode:
            ...
            for data in inputs[self.resume:]:
                ...
                if data[0] != "#":
                    ...
                    if url != " ":
                        ...
                        # print("-------------{}/{}------\n".format(str(i)))
                        self.Hitting_url(self.input_url, district_code,tehsil_code,village_code,khasra_number, False, False)
                    with open(self.current_path + '/' + "Resume.txt", "w", encoding='utf-8') as f:
                        f.write(str(data))
                i += 1
    ...
    def Hitting_url(self, url, district_code,tehsil_code,village_code,khasra_number, Main, is_paginated):
        self.retries = 0
        while True:
            try:
                ...
                district_name = main_tree.xpath(f"//*[contains(text(),'Select District')]//..//select//option[@value={district_code}]//text()")[0]
                # district_code = main_tree.xpath(f"//*[contains(text(),'Select District')]//..//select//option[@value={district_code}]//@value")[0]
                district_payload = {
                ...
                tehsil_name = district_tree.xpath(f"//*[contains(text(),'Select Tehsil/ Sub-Tehsil')]//..//select//option[@value={tehsil_code}]//text()")[0]
                # tehsil_code = district_tree.xpath(f"//*[contains(text(),'Select Tehsil/ Sub-Tehsil')]//..//select//option[@value={tehsil_code}]//@value")[0]
                tehsil_payload = {
                ...
                village_name = tehsil_tree.xpath(f"//*[contains(text(),'Select Village')]//..//select//option[@value={village_code}]//text()")[0]
                # village_code = tehsil_tree.xpath(f"//*[contains(text(),'Select Village')]//..//select//option[@value={village_code}]//@value")[0]
                village_payload = {
